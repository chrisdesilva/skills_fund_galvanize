...
const Popup = props => {
    ...
    const handleSubmit = e => {
        ...
        "fields": [
            ...
            "value": `https://galvanize.skills.fund`
            }
        ],
        "context": {
            "hutk": hsCookie.hubspotutk,
            "pageUri": `https://galvanize.skills.fund`,
    ...
    return (
        <div className={isPopupVisible ? "popup" : "popup hidePopup"}>
            ...
            <form className="popup_capture program-apply flex flex-col lg:flex-row m-0 items-center" onSubmit={handleSubmit}>
                {!thankYou && isPopupVisible && <input className="border-2 rounded border-primary text-left p-2 w-64 text-black" type="email" name="email" placeholder="Enter your email address" onChange={handleChange} value={email} required />}
                <div className="hidden">
                    ...
                    <input type="text" name="Lead Form Submit Page" value={props.pageUri} readOnly/>
                </div>
